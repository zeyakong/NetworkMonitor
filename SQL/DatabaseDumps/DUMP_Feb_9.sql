...
CREATE TABLE `connections` (
  ...
  CONSTRAINT `MerchantID` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_ip`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `transactions` (
  ...
  CONSTRAINT `StoreID` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_ip`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-02-09 20:13:33
