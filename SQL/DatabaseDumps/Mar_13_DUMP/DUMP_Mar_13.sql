...
CREATE TABLE `relay_stations` (
  ...
  `is_active` tinyint(4) NOT NULL DEFAULT '1',
  `station_type` tinyint(4) NOT NULL DEFAULT '0',
  `region` tinyint(4) NOT NULL DEFAULT '0',
  `trasaction_limit` int(11) NOT NULL DEFAULT '30',
...
CREATE TABLE `transactions` (
  ...
  `transaction_date_sent` datetime NOT NULL,
  `transaction_type` varchar(10) NOT NULL,
  `transaction_amount` decimal(10,2) NOT NULL,
  `transaction_status` tinyint(4) NOT NULL,
  `transaction_date_responded` datetime NOT NULL,
...
-- Dump completed on 2018-03-13 18:04:23
