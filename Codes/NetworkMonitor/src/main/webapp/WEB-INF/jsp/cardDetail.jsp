...
<div class="main-content">
    ...
    margin-left:0px;">
        <tr>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Card Number
            </td>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                style="width:200px;height:50px;">${creditCard.cardId}</td>
        </tr>
        <tr>
            ...
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                style="width:200px;height:50px;">${creditCard.cardName}</td>
        </tr>
        <tr>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Card Account
            </td>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                style="width:200px;height:50px;">${creditCard.cardAccount}</td>
        </tr>
        <tr>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Expiration Date
            </td>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                style="width:200px;height:50px;">${creditCard.expirationDate}</td>
        </tr>
        <tr>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Security Code
            </td>
            <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                style="width:200px;height:50px;">${creditCard.securityCode}</td>
        </tr>
       <%-- <tr>
    ...
    <c:forEach var="ac" items="${list}">
        <table class="table table-bordered" >
            <tr>
                ...
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.transactionAmount}</td>
            </tr>
            <tr>
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Store Ip
                </td>
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.storeIp}</td>

            </tr>
            <tr>
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">Current Destination Ip
                </td>
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.currentDestinationIp}</td>
            ...
            <tr>
                ...
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.currentPositionIp}</td>
            </tr>
            ...
            <tr>
                ...
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.transactionStatus}</td>
            </tr>
            <tr>
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="width:200px;height:50px;">
                    Transaction Type
                ...
                <td class="resp-tab-item" aria-controls="tab_item-0" role="tab"
                    style="width:200px;height:50px;">${ac.transactionType}</td>
            </tr>
        </table>
    </c:forEach>
</div>
