...
<div class="main-content">
    <div class="sign-up" style="width:100px;height:50px;margin-top:80px;margin-left:80px;">
        <input type="submit" class="submit-btn" id="J_submit" value="Back" style="width:100px;height:50px;height:50px;margin-top:80px;margin-left:80px;"
    ...
    <div class="sap_tabs">
                ...
                <div class="facts">
                    <div class="register">
                        ...
                        <h3>Expiration date:<input placeholder="MM/YYYY"  value="${creditCard.expirationDate}" id="cdate2" class="lock" type="text" required="" ></h3>
